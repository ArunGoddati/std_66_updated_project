...
function Sidebar() {
  return (
    <div className="sidebar p-3 side_bar">
      ...
      <Nav className="flex-column">
        ...
        <Nav.Link href="#" className='text-truncate'><i className="bi bi-chat-dots"></i> Messages <span className="badge bg-dark">5</span></Nav.Link>
